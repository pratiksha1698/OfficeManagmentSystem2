package com.example.officemanagmentsystem;
...
import com.example.officemanagmentsystem.Module.Data;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Firebase Database
        if (uId != null) {
            databaseReference = FirebaseDatabase.getInstance().getReference().child("TaskNote").child(uId);//it checks the uid of parent.
        }
